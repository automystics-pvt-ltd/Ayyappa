...
const faqs = [
  {
    q: "நன்கொடை வருமான வரி விலக்கு பெறுமா?",
    a: "தேவையான அனுமதி இருந்தால் விவரங்கள் வழங்கப்படும்."
  },
  {
    q: "ஆன்லைனில் நன்கொடை வழங்கலாமா?",
    a: "ஆம். UPI, Net Banking, Debit Card, Credit Card ஆகியவற்றின் மூலம் வழங்கலாம்."
  },
  {
    q: "ரசீது கிடைக்குமா?",
    a: "ஆம். உடனடியாக மின்னஞ்சல் மற்றும் WhatsApp மூலம் அனுப்பப்படும்."
  }
];
